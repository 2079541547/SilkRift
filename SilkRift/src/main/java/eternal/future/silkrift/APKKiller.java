...
public class APKKiller {
    private static final String TAG = "APKKiller";
    private static volatile String packageName;
    private static volatile String apkPath;
    private static volatile Object proxy;
    private static volatile Object originalPkgMgr;
    private static volatile byte[] fakeSignature;
    ...
    public static void init(Context context, String targetApkPath) {
        ...
        try {
            ...
            if (fakeSignature == null) {
                throw new IllegalStateException("Failed to get signature from target APK");
            }
    ...
    private static void patchSignatures(PackageInfo pkgInfo) {
    ...
    private static void patchSigningInfo(PackageInfo pkgInfo) {
    ...
    private static void patchSigningInfoInternal(Object signingInfo) throws Exception {
    ...
    private static void patchApplicationInfo(Object activityThread) throws Exception {
    ...
    private static void patchLoadedApk(Object activityThread) throws Exception {
    ...
    private static void patchAppBindData(Object activityThread) throws Exception {
    ...
    private static void patchApplication(Object activityThread) throws Exception {
    ...
    private static void patchPackageManager(Context context) throws Exception {
